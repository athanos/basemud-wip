...
{
        if ( list->_pFirstCell == cell ) list->_pFirstCell = cell->_pNextCell;
        if ( list->_pLastCell == cell ) list->_pLastCell = cell->_pPrevCell;
        if ( cell->_pPrevCell ) cell->_pPrevCell->_pNextCell = cell->_pNextCell;
        if ( cell->_pNextCell ) cell->_pNextCell->_pPrevCell = cell->_pNextCell;
...
void DeleteList( LIST *list )
{
        ...
        for ( cell = list->_pFirstCell; cell; cell = cell_next )
        {
                cell_next = cell->_pNextCell;
